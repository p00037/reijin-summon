...
カードは[参照一覧](https://w.atwiki.jp/ewwiki/pages/25.html)のSC001〜SC020を収録し、番号・名前・兵種・CO/LV・HP・AT・INTを登録しています。移動・射程・生成時間・アビリティは既存の兵種共通値です。INTは表示のみで、固有アビリティと召喚獣選択は今回の対象外です。
